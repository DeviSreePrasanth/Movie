...
const Header = () => {
  ...
  const [mobileSearchFocused, setMobileSearchFocused] = useState(false); // Added for mobile search
    ...
    <nav className="fixed top-0 left-0 w-full bg-transparent backdrop-blur-md text-white py-4 px-6 z-40">
      ...
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          {/* Mobile Search Bar */}
          <div
            className={`flex items-center bg-gray-800/50 backdrop-blur-sm rounded-full px-4 py-2 mb-4 transition-all duration-300 ${
              mobileSearchFocused ? "w-full bg-gray-700/70 shadow-md" : "w-full"
            }`}
          >
            <input
              type="text"
