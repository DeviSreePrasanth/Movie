                  ...
                  <div key={rowLabel} className="flex items-center mb-4 w-full max-w-4xl justify-center">
                    ...
                    <div className="flex gap-2 flex-wrap justify-center">
                      {Array.from({ length: leftSeats }).map((_, seatIndex) => {
                        ...
                        const isBooked = bookedSeats.some((seat) => seat.row === rowLabel && seat.seat === seatNumber);
                        const isSelected = selectedSeats.some((seat) => seat.row === rowLabel && seat.seat === seatNumber);
